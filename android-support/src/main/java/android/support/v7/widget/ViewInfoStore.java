...
class ViewInfoStore {
     ...
     * @param holder The RecyclerViewHolder whose information is being saved
    ...
    /**
     * Finds the ItemHolderInfo for the given RecyclerViewHolder in preLayout list and removes it.
     *
     * @param vh The RecyclerViewHolder whose information is being queried
     * @return The ItemHolderInfo for the given RecyclerViewHolder or null if it does not exist
     */
    @Nullable
    ...
    /**
     * Finds the ItemHolderInfo for the given RecyclerViewHolder in postLayout list and removes it.
     *
     * @param vh The RecyclerViewHolder whose information is being queried
     * @return The ItemHolderInfo for the given RecyclerViewHolder or null if it does not exist
     */
    ...
    /**
     * Adds the given RecyclerViewHolder to the oldChangeHolders list
     * @param key The key to identify the RecyclerViewHolder.
     * @param holder The RecyclerViewHolder to store
     */
    ...
    /**
     * Adds the given RecyclerViewHolder to the appeared in pre layout list. These are Views added by the
    ...
    /**
     * Checks whether the given RecyclerViewHolder is in preLayout list
     * @param viewHolder The RecyclerViewHolder to query
     *
     * @return True if the RecyclerViewHolder is present in preLayout, false otherwise
     */
     ...
     * null.
     * @param key The key to be used to find the RecyclerViewHolder.
     *
     * @return A RecyclerViewHolder if exists or null if it does not exist.
     */
    ...
    /**
     * A RecyclerViewHolder might be added by the LayoutManager just to animate its disappearance.
     * This list holds such items so that we can animate / recycle these ViewHolders properly.
     *
     * @param holder The RecyclerViewHolder which disappeared during a layout.
     */
    ...
    /**
     * Removes a RecyclerViewHolder from disappearing list.
     * @param holder The RecyclerViewHolder to be removed from the disappearing list.
     */
    ...
    /**
     * Removes the RecyclerViewHolder from all list
     * @param holder The RecyclerViewHolder which we should stop tracking
     */
