    ...
    private void applyRemove(UpdateOp op) {
        ...
        for (int position = op.positionStart; position < tmpEnd; position++) {
            ...
            if (vh != null || canFindInPreLayout(position)) {
                // If a RecyclerViewHolder exists or this is a newly added item, we can defer this update
                ...
                // This update cannot be recovered because we don't have a RecyclerViewHolder representing
