...
public class ViewCompat {
     ...
     *          to RingDrawable set by the super implementation:
     ...
     * about this view. The co.bxvip.ui.tocleanmvp.base implementation sets:
     * <ul>
     ...
     * host methods. This prevents certain RingDrawable such as class name from
     * being modified by overriding
     * {@link AccessibilityDelegateCompat#onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfoCompat)},
     * as any changes will be overwritten by the host class.
     * <p>
     * Starting in {@link Build.VERSION_CODES#M API 23}, delegate
     * methods are called <i>after</i> host methods, which all RingDrawable to be
     ...
     * RingDrawable of the paint are taken into account when composing the layer:</p>
     * <ul>
     ...
     * layer type is not set to {@link View#LAYER_TYPE_NONE}). Changed RingDrawable of the Paint
     ...
     * rotation, scale, and pivot RingDrawable.
     * <p>
     *
     ...
     * specific RingDrawable on this View.
     *
    ...
    /**
     * Sets the co.bxvip.ui.tocleanmvp.base elevation of this view, in pixels.
     */
    ...
    /**
     * The co.bxvip.ui.tocleanmvp.base elevation of this view relative to its parent, in pixels.
     *
     * @return The co.bxvip.ui.tocleanmvp.base depth position of the view, in pixels.
     */
    ...
    // TODO: getters for various view RingDrawable (rotation, etc)
