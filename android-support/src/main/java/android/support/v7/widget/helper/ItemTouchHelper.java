...
import static android.support.v7.widget.builder.RecycleViewDimen.item_touch_helper_max_drag_scroll_per_frame;
import static android.support.v7.widget.builder.RecycleViewDimen.item_touch_helper_swipe_escape_max_velocity;
import static android.support.v7.widget.builder.RecycleViewDimen.item_touch_helper_swipe_escape_velocity;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * Re-use array to calculate dx dy for a RecyclerViewHolder
     */
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = dip2Px(resources,item_touch_helper_swipe_escape_velocity);
            mMaxSwipeVelocity = dip2Px(resources,item_touch_helper_swipe_escape_max_velocity);
            setupCallbacks();
        }
    }
     ...
     *
     * @param selected    The RecyclerViewHolder to drag or swipe. Can be null if you want to cancel the
     *                    current action
    ...
    /**
     * Starts dragging the provided RecyclerViewHolder. By default, ItemTouchHelper starts a drag when a
     * View is long pressed. You can disable that behavior by overriding
     * {@link Callback#isLongPressDragEnabled()}.
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided RecyclerViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper
     * is attached.</li>
     ...
     * <p>
     *
     * @param viewHolder The RecyclerViewHolder to start dragging. It must be a direct child of
     *                   RecyclerView.
    ...
    /**
     * Starts swiping the provided RecyclerViewHolder. By default, ItemTouchHelper starts swiping a View
     ...
     * </pre>
     *
     * @param viewHolder The RecyclerViewHolder to start swiping. It must be a direct child of
     *                   RecyclerView.
     */
     ...
     * which touch behaviors are enabled per each RecyclerViewHolder and also receive callbacks when user
    ...
    public abstract static class Callback {
         ...
         * <pre>
         *     public void clearView(RecyclerView recyclerView, RecyclerView.RecyclerViewHolder viewHolder){
         *         getDefaultUIUtil().clearView(((ItemTouchViewHolder) viewHolder).textView);
         *     }
         *     public void onSelectedChanged(RecyclerView.RecyclerViewHolder viewHolder, int actionState) {
         *         if (viewHolder != null){
         *             getDefaultUIUtil().onSelected(((ItemTouchViewHolder) viewHolder).textView);
         *         }
         *     }
         *     public void onChildDraw(Canvas c, RecyclerView recyclerView,
         *             RecyclerView.RecyclerViewHolder viewHolder, float dX, float dY, int actionState,
         ...
         * @param viewHolder   The RecyclerViewHolder for which the movement information is necessary.
         * @return flags specifying which movements are allowed on this RecyclerViewHolder.
        ...
        /**
         * Return true if the current RecyclerViewHolder can be dropped over the the target RecyclerViewHolder.
         * <p>
         ...
         * @param current      The RecyclerViewHolder that user is dragging.
         * @param target       The RecyclerViewHolder which is below the dragged RecyclerViewHolder.
         * @return True if the dragged RecyclerViewHolder can be replaced with the target RecyclerViewHolder, false
         * otherwise.
         */
         ...
         * to the adapter position of {@code target} RecyclerViewHolder
         ...
         *
         * @param recyclerView The RecyclerView to which ItemTouchHelper is attached to.
         * @param viewHolder   The RecyclerViewHolder which is being dragged by the user.
         * @param target       The RecyclerViewHolder over which the currently active item is being
         *                     dragged.
         ...
         *
         * @param viewHolder The RecyclerViewHolder that is being dragged.
         ...
         *
         * @param selected    The RecyclerViewHolder being dragged by the user.
         * @param dropTargets The list of RecyclerViewHolder that are under the dragged View and
         *                    candidate as a drop.
         ...
         *                    are applied. This value does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         * @return A RecyclerViewHolder to whose position the dragged RecyclerViewHolder should be
         * moved to.
         */
        ...
        /**
         * Called when a RecyclerViewHolder is swiped by the user.
         * <p>
         ...
         *
         * @param viewHolder The RecyclerViewHolder which has been swiped by the user.
         * @param direction  The direction to which the RecyclerViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
        ...
        /**
         * Called when the RecyclerViewHolder swiped or dragged by the ItemTouchHelper is changed.
         * <p/>
         * If you override this method, you should call super.
         *
         * @param viewHolder  The new RecyclerViewHolder that is being swiped or dragged. Might be null if
         *                    it is cleared.
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = dip2Px(recyclerView.getResources(),item_touch_helper_max_drag_scroll_per_frame);
            }
         ...
         * <p>
         * It is important to ensure the RecyclerViewHolder will stay visible as otherwise, it might be
         * removed by the LayoutManager if the move causes the View to go out of bounds. In that
         * case, drag will end prematurely.
         *
         * @param recyclerView The RecyclerView controlled by the ItemTouchHelper.
         * @param viewHolder   The RecyclerViewHolder under user's control.
         * @param fromPos      The previous adapter position of the dragged item (before it was
         *                     moved).
         * @param target       The RecyclerViewHolder on which the currently active item has been dropped.
         ...
         * @param recyclerView      The RecyclerView to which ItemTouchHelper is attached to
         * @param viewHolder        The RecyclerViewHolder which is being interacted by the User or it was
        ...
        /**
         * Called by the ItemTouchHelper when user action finished on a RecyclerViewHolder and now the View
     ...
     *         public abstract boolean onMove(RecyclerView recyclerView,
     *             RecyclerViewHolder viewHolder, RecyclerViewHolder target) {
     *             final int fromPos = viewHolder.getAdapterPosition();
     *             final int toPos = target.getAdapterPosition();
     *             // move item in `fromPos` to `toPos` in adapter.
     *             return true;// true if moved, false otherwise
     *         }
     *         public void onSwiped(RecyclerViewHolder viewHolder, int direction) {
     *             // remove from adapter
     *         }
     * });
     * </pre>
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * defaults
         * and if you want to customize behavior per RecyclerViewHolder, you can override
        ...
        /**
         * Returns the swipe directions for the provided RecyclerViewHolder.
        ...
        /**
         * Returns the drag directions for the provided RecyclerViewHolder.
