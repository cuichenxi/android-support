...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
     ...
     * {@inheritDoc}
     *
     * @return True if change animations are not supported or the RecyclerViewHolder is invalid,
     * false otherwise.
     *
     ...
     * {@link #dispatchChangeFinished(ViewHolder, boolean)} for each non-null distinct RecyclerViewHolder,
     * either immediately (if no animation will occur) or after the animation actually finishes.
     * If the {@code oldHolder} is the same RecyclerViewHolder as the {@code newHolder}, you must call
     ...
     *                each non-null RecyclerViewHolder passed into
    ...
    /**
     * Called when a remove animation is being started on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
     * @param item The RecyclerViewHolder being animated.
     */
    ...
    /**
     * Called when a remove animation has ended on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when an add animation is being started on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when an add animation has ended on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when a move animation is being started on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when a move animation has ended on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when a change animation is being started on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
    ...
    /**
     * Called when a change animation has ended on the given RecyclerViewHolder.
     * The default implementation does nothing. Subclasses may wish to override
     * this method to handle any RecyclerViewHolder-specific operations linked to animation
     * lifecycles.
     *
