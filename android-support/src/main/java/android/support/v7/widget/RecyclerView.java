...
import android.support.v7.widget.builder.RecycleViewDimen;
import android.support.v7.widget.builder.RecyclerBuilder;
 ...
 * For example, if you want to access the item in the adapter on a RecyclerViewHolder click, you should use
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
     ...
     * a View is two levels deep(wrt to RecyclerViewHolder.itemView). DisplayList can be invalidated by
     ...
     * > Adapter#onFailedToRecycleView(RecyclerViewHolder)})
     * <p>
    ...
    private RecyclerBuilder recyclerBuilder = null;
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (recyclerBuilder == null) {
            recyclerBuilder = RecyclerBuilder.newBuild();
        }
        ...
        if (attrs != null) {
            int defStyleRes = 0;
            String layoutManagerName = recyclerBuilder.getLayoutManager();
            int descendantFocusability = recyclerBuilder.getDescendantFocusability();
            if (descendantFocusability == -1) {
                setDescendantFocusability(ViewGroup.FOCUS_AFTER_DESCENDANTS);
            }
            mEnableFastScroller = recyclerBuilder.isFastScrollEnabled();
            if (mEnableFastScroller) {
                StateListDrawable verticalThumbDrawable = (StateListDrawable) context.getResources().getDrawable(recyclerBuilder.getFastScrollVerticalThumbDrawable());
                Drawable verticalTrackDrawable = context.getResources().getDrawable(recyclerBuilder.getFastScrollVerticalTrackDrawable());
                StateListDrawable horizontalThumbDrawable = (StateListDrawable) context.getResources().getDrawable(recyclerBuilder.getFastScrollHorizontalThumbDrawable());
                Drawable horizontalTrackDrawable = context.getResources().getDrawable(recyclerBuilder.getFastScrollHorizontalTrackDrawable());
    ...
    public RecyclerView setRecyclerBuilder(RecyclerBuilder builder) {
        this.recyclerBuilder = builder;
        return this;
    }
     ...
     *
     * @param viewHolder The RecyclerViewHolder to be removed
     */
        ...
        if (mState.mRunSimpleAnimations) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (mState.mTrackOldChangeHolders && holder.isUpdated() && !holder.isRemoved()
                    ...
                    // This is NOT the only place where a RecyclerViewHolder is added to old change holders
     ...
     * @param holder              Current RecyclerViewHolder
     * @param oldChangeViewHolder Changed RecyclerViewHolder
     */
    ...
    void viewRangeUpdate(int positionStart, int itemCount, Object payload) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (holder.mPosition >= positionStart && holder.mPosition < positionEnd) {
                ...
                // lp cannot be null since we get RecyclerViewHolder from it.
                ((LayoutParams) child.getLayoutParams()).mInsetsDirty = true;
            }
        }
     ...
     *
     * @param child Child of this RecyclerView to query for its RecyclerViewHolder
     * @return The child view's RecyclerViewHolder
     */
     ...
     * RecyclerViewHolder by calling {@link #getChildViewHolder(View)}.
     *
    ...
    /**
     * Returns the RecyclerViewHolder that contains the given view.
     *
     * @param view The view that is a descendant of the RecyclerView.
     * @return The RecyclerViewHolder that contains the given view or null if the provided view is not a
    ...
    /**
     * Return the RecyclerViewHolder for the item in the given position of the data set as of the latest
     * layout pass.
     * <p>
     * This method checks only the children of RecyclerView. If the item at the given
     * <code>position</code> is not laid out, it <em>will not</em> create a new one.
     * <p>
     * Note that when Adapter contents change, RecyclerViewHolder positions are not updated until the
     ...
     * #{@link ViewHolder#getAdapterPosition()} to get the current adapter position of a RecyclerViewHolder.
     * <p>
     ...
     * RecyclerViewHolder will be returned.
     *
     * @param position The position of the item in the data set of the adapter
     * @return The RecyclerViewHolder at <code>position</code> or null if there is no such item
     */
    ...
    /**
     * Return the RecyclerViewHolder for the item in the given position of the data set. Unlike
     ...
     * <p>
     * When the ItemAnimator is running a change animation, there might be 2 ViewHolders
     * representing the same Item. In this case, the updated RecyclerViewHolder will be returned.
     *
     * @param position The position of the item in the data set of the adapter
     * @return The RecyclerViewHolder at <code>position</code> or null if there is no such item
     */
    ...
    /**
     * Return the RecyclerViewHolder for the item with the given id. The RecyclerView must
     ...
     * same id. In this case, the updated RecyclerViewHolder will be returned.
     *
     * @param id The id for the requested item
     * @return The RecyclerViewHolder with the given <code>id</code> or null if there is no such item
     */
    ...
    void dispatchOnScrolled(int hresult, int vresult) {
        ...
        // Pass the current scrollX/scrollY values; no actual change in these RingDrawable occurred
    ...
    void dispatchOnScrollStateChanged(int state) {
        // Let the LayoutManager go first; this allows it to bring any RingDrawable into
    ...
    public static class RecycledViewPool {
         ...
         * adapter uses a different RecyclerViewHolder than the oldAdapter.
         *
         * @param oldAdapter             The previous adapter instance. Will be detached.
         * @param newAdapter             The new adapter instance. Will be attached.
         * @param compatibleWithPrevious True if both oldAdapter and newAdapter are using the same
         *                               RecyclerViewHolder and view types.
         */
    ...
    /**
     * Time co.bxvip.ui.tocleanmvp.base for deadline-aware work scheduling. Overridable for testing.
     * <p>
    ...
    public final class Recycler {
         ...
         * @return true if RecyclerViewHolder matches the provided position, false otherwise
         */
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            if (holder == null) {
                throw new IllegalArgumentException("The view does not have a RecyclerViewHolder. You cannot"
         ...
         * <p>
         * Note that if the provided position belongs to a deleted RecyclerViewHolder, this method will
         * return -1.
         * <p>
        ...
        /**
         * Attempts to get the RecyclerViewHolder for the given position, either from the Recycler scrap,
         * cache, the RecycledViewPool, or creating it directly.
         * <p>
         * If a deadlineNs other than {@link #FOREVER_NS} is passed, this method early return
         * rather than constructing or binding a RecyclerViewHolder if it doesn't think it has time.
         * If a RecyclerViewHolder must be constructed and not enough time remains, null is returned. If a
         * RecyclerViewHolder is aquired and must be bound but not enough time remains, an unbound holder is
         * returned. Use {@link ViewHolder#isBound()} on the returned object to check for this.
         *
         * @param position   Position of RecyclerViewHolder to be returned.
         * @param dryRun     True if the RecyclerViewHolder should not be removed from scrap/cache/
         * @param deadlineNs Time, relative to getNanoTime(), by which bind/create work should
         *                   complete. If FOREVER_NS is passed, this method will not fail to
         *                   create/bind the holder if needed.
         * @return RecyclerViewHolder for requested position
         */
        @Nullable
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            if (holder == null) {
                    ...
                    if (view != null) {
                        ...
                        if (holder == null) {
                            throw new IllegalArgumentException("getViewForPositionAndType returned"
                                    + " a view which does not have a RecyclerViewHolder"
                                    + exceptionLabel());
                ...
                if (holder == null) {
                    ...
                    if (DEBUG) {
                        Log.d(TAG, "tryGetViewHolderForPositionByDeadline created new RecyclerViewHolder");
                    }
                }
            }
        ...
        /**
         * Prepares the RecyclerViewHolder to be removed/recycled, and inserts it into the RecycledViewPool.
         * <p>
         ...
         * @param dryRun   Does a dry run, finds the RecyclerViewHolder but does not remove
         * @return a RecyclerViewHolder that can be re-used for this position.
         */
         ...
         * @param applyToPreLayout If true, changes will affect RecyclerViewHolder's pre-layout position, if
     ...
     *
     * @param <VH> A class that extends RecyclerViewHolder that will be used by the adapter.
     */
    public abstract static class Adapter<VH extends ViewHolder> {
         ...
         * an item.
         * <p>
         * This new RecyclerViewHolder should be constructed with a new View that can represent the items
         ...
         * @return A new RecyclerViewHolder that holds a View of the given view type.
         ...
         *
         * @param holder   The RecyclerViewHolder which should be updated to represent the contents of the
         ...
         * the RecyclerViewHolder is currently bound to old data and Adapter may run an efficient partial
         ...
         * resources.</p>
         * <p>
         * RecyclerView calls this method right before clearing RecyclerViewHolder's internal data and
         * sending it to RecycledViewPool. This way, if RecyclerViewHolder was holding valid information
         * before being recycled, you can call {@link ViewHolder#getAdapterPosition()} to get
         * its adapter position.
         *
         * @param holder The RecyclerViewHolder for the view being recycled
         */
        public void onViewRecycled(VH holder) {
        }

        /**
         * Called by the RecyclerView if a RecyclerViewHolder created by this Adapter cannot be recycled
         ...
         *
         * @param holder The RecyclerViewHolder containing the View that could not be recycled due to its
         *               transient state.
         ...
         * item is already represented by a RecyclerViewHolder and it will be rebound to the same
         * RecyclerViewHolder. A notifyItemRangeChanged() with null payload will clear all existing
     ...
     * instantiate and set the LayoutManager when being inflated. Most used RingDrawable can
     * be then obtained from {@link #}. In case
    ...
    public abstract static class LayoutManager {
         ...
         * <p>
         * <p>The co.bxvip.ui.tocleanmvp.base implementation will attempt to perform a standard programmatic scroll
         ...
         * the minimum width and height RingDrawable of the host RecyclerView if measured
    ...
    public interface RecyclerListener {
        ...
        /**
         * This method is called whenever the view in the RecyclerViewHolder is recycled.
         * <p>
         * RecyclerView calls this method right before clearing RecyclerViewHolder's internal data and
         * sending it to RecycledViewPool. This way, if RecyclerViewHolder was holding valid information
         * before being recycled, you can call {@link ViewHolder#getAdapterPosition()} to get
         * its adapter position.
         *
         * @param holder The RecyclerViewHolder containing the view that was recycled
         */
     ...
     * whenever a RecyclerViewHolder is attached to or detached from RecyclerView.
     */
    ...
    /**
     * A RecyclerViewHolder describes an item view and metadata about its place within the RecyclerView.
     * <p>
     * <p>{@link Adapter} implementations should subclass RecyclerViewHolder and add fields for caching
     * potentially expensive {@link View#findViewById(int)} results.</p>
     * <p>
     * <p>While {@link LayoutParams} belong to the {@link LayoutManager},
     * {@link ViewHolder ViewHolders} belong to the adapter. Adapters should feel free to use
     * their own custom RecyclerViewHolder implementations to store data that makes binding view contents
     * easier. Implementations should assume that individual item views will hold strong references
     * to <code>RecyclerViewHolder</code> objects and that <code>RecyclerView</code> instances may hold
    ...
    public abstract static class ViewHolder {
        ...
        /**
         * This RecyclerViewHolder has been bound to a position; mPosition, mItemId and mItemViewType
         * are all valid.
         */
        static final int FLAG_BOUND = 1 << 0;

        /**
         * The data this RecyclerViewHolder's view reflects is stale and needs to be rebound
         * by the adapter. mPosition and mItemId are consistent.
         */
        static final int FLAG_UPDATE = 1 << 1;

        /**
         * This RecyclerViewHolder's data is invalid. The identity implied by mPosition and mItemId
         * are not to be trusted and may no longer match the item view type.
         * This RecyclerViewHolder must be fully rebound to different data.
         */
        static final int FLAG_INVALID = 1 << 2;

        /**
         * This RecyclerViewHolder points at data that represents an item previously removed from the
         * data set. Its view may still be used for things like outgoing animations.
         */
        static final int FLAG_REMOVED = 1 << 3;

        /**
         * This RecyclerViewHolder should not be recycled. This flag is set via setIsRecyclable()
         * and is intended to keep views around during animations.
         */
        static final int FLAG_NOT_RECYCLABLE = 1 << 4;

        /**
         * This RecyclerViewHolder is returned from scrap which means we are expecting an addView call
         * for this itemView. When returned from scrap, RecyclerViewHolder stays in the scrap list until
        ...
        /**
         * This RecyclerViewHolder is fully managed by the LayoutManager. We do not scrap, recycle or remove
        ...
        /**
         * Set when we can no longer determine the adapter position of this RecyclerViewHolder until it is
        ...
        /**
         * Used by ItemAnimator when a RecyclerViewHolder's position changes
         */
        static final int FLAG_MOVED = 1 << 11;

        /**
         * Used by ItemAnimator when a RecyclerViewHolder appears in pre-layout
         */
        ...
        /**
         * Used when a RecyclerViewHolder starts the layout pass as a hidden RecyclerViewHolder but is re-used from
         * hidden list (as if it was scrap) without being recycled in between.
         * <p>
         * When a RecyclerViewHolder is hidden, there are 2 paths it can be re-used:
         * a) Animation ends, view is recycled and used from the recycle pool.
         * b) LayoutManager asks for the View for that position while the RecyclerViewHolder is hidden.
         * <p>
         * This flag is used to represent "case b" where the RecyclerViewHolder is reused without being
         * recycled (thus "bounced" from the hidden list). This state requires special handling
         * because the RecyclerViewHolder must be added to pre layout maps for animations as if it was
         * already there.
         */
        ...
        // Keeps whether this RecyclerViewHolder lives in Change scrap or Attached scrap
        ...
        /**
         * Returns the position of the RecyclerViewHolder in terms of the latest layout pass.
         * <p>
         ...
         *
         * @return Returns the adapter position of the RecyclerViewHolder in the latest layout pass.
         * @see #getAdapterPosition()
         */
        ...
        /**
         * Returns the Adapter position of the item represented by this RecyclerViewHolder.
         * <p>
         ...
         * 16ms but it might be a problem if you want to use RecyclerViewHolder position to access the
         * adapter. Sometimes, you may need to get the exact adapter position to do
         * some actions in response to user events. In that case, you should use this method which
         * will calculate the Adapter position of the RecyclerViewHolder.
         * <p>
         ...
         * layout pass or the RecyclerViewHolder has already been recycled.
         */
         ...
         * <p>
         * If a RecyclerViewHolder was laid out in the previous onLayout call, old position will keep its
         * adapter index in the previous layout.
         *
         * @return The previous adapter index of the Item represented by this RecyclerViewHolder or
        ...
        /**
         * Returns The itemId represented by this RecyclerViewHolder.
         *
        ...
        /**
         * @return The view type of this RecyclerViewHolder.
         */
        ...
        public String toString() {
            final StringBuilder sb = new StringBuilder("RecyclerViewHolder{"
        ...
        /**
         * @return True if RecyclerViewHolder is not referenced by RecyclerView animations but has
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable,
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable,
                ...
                dip2Px(resources, RecycleViewDimen.fastscroll_default_thickness),
                dip2Px(resources, RecycleViewDimen.fastscroll_minimum_range),
                dip2Px(resources, RecycleViewDimen.fastscroll_margin));
    }
    ...
    /**
     * Observer co.bxvip.ui.tocleanmvp.base class for watching changes to an {@link Adapter}.
     ...
     * RecyclerViewHolder items. The RecyclerView will manage retaining these items while they
     * are being animated, but implementors must call {@link #dispatchAnimationFinished(ViewHolder)}
     * when a RecyclerViewHolder's animation is finished. In other words, there must be a matching
    ...
    public abstract static class ItemAnimator {
        ...
        /**
         * The Item represented by this RecyclerViewHolder is updated.
         * <p>
         *
        ...
        /**
         * The Item represented by this RecyclerViewHolder is removed from the adapter.
         * <p>
         *
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
         ...
         * represented by this RecyclerViewHolder is invalid.
         * <p>
         *
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
        ...
        /**
         * The position of the Item represented by this RecyclerViewHolder has been changed. This flag is
        ...
        /**
         * This RecyclerViewHolder was not laid out but has been added to the layout in pre-layout state
         ...
         * @param viewHolder  The RecyclerViewHolder whose information should be recorded.
         * @param changeFlags Additional information about what changes happened in the Adapter
         *                    about the Item represented by this RecyclerViewHolder. For instance, if
         ...
         * RecyclerViewHolder. This object will be passed back to related <code>animate**</code> methods
         ...
         * @param viewHolder The RecyclerViewHolder whose information should be recorded.
         * @return An ItemHolderInfo that preserves necessary information about the RecyclerViewHolder.
        ...
        /**
         * Called by the RecyclerView when a RecyclerViewHolder has disappeared from the layout.
         * <p>
         ...
         * {@link #recordPreLayoutInformation(State, ViewHolder, int, List)}.
         * <p>
         * Note that when a RecyclerViewHolder both changes and disappears in the same layout pass, the
         * animation callback method which will be called by the RecyclerView depends on the
         * ItemAnimator's decision whether to re-use the same RecyclerViewHolder or not, and also the
         * LayoutManager's decision whether to layout the changed version of a disappearing
         * RecyclerViewHolder or not. RecyclerView will call
         * {@link #animateChange(ViewHolder, ViewHolder, ItemHolderInfo, ItemHolderInfo)
         ...
         *
         * @param viewHolder     The RecyclerViewHolder which should be animated
        ...
        /**
         * Called by the RecyclerView when a RecyclerViewHolder is added to the layout.
         * <p>
         * In detail, this means that the RecyclerViewHolder was <b>not</b> a child when the layout started
         ...
         *                       not predict that this RecyclerViewHolder will become visible.
        ...
        /**
         * Called by the RecyclerView when a RecyclerViewHolder is present in both before and after the
         ...
         * <p>
         * This RecyclerViewHolder still represents the same data that it was representing when the layout
         ...
         * called for the new RecyclerViewHolder and the old one will be recycled.
         * <p>
         ...
         * previous presentation of the item as-is and supply a new RecyclerViewHolder for the updated
         ...
         * and elegant to re-use the same RecyclerViewHolder and animate the content changes manually.
         * <p>
         ...
         * this RecyclerViewHolder when {@link #canReuseUpdatedViewHolder(ViewHolder, List)} was called, the
         * <code>oldHolder</code> and <code>newHolder</code> will be different RecyclerViewHolder instances
         * which represent the same Item. In that case, only the new RecyclerViewHolder is visible
         * to the LayoutManager but RecyclerView keeps old RecyclerViewHolder attached for animations.
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(ViewHolder)} for each distinct
         * RecyclerViewHolder when their animation is complete
         ...
         * Built-in LayoutManagers try to avoid laying out updated versions of disappearing views.
         *
         * @param oldHolder      The RecyclerViewHolder before the layout is started, might be the same
         *                       instance with newHolder.
         * @param newHolder      The RecyclerViewHolder after the layout is finished, might be the same
         ...
         * are canceled and affected RingDrawable are set to their end values.
         ...
         *
         * @param viewHolder The RecyclerViewHolder whose animation is finished.
         ...
         * ItemAnimator.
         *
         * @param viewHolder The RecyclerViewHolder whose animation is finished. There might still be other
         *                   animations running on this RecyclerViewHolder.
         ...
         * and <code>newHolder</code> (if they are not the same instance).
         * <p>
         * If your ItemAnimator decides not to animate a RecyclerViewHolder, it should call
         * {@link #dispatchAnimationFinished(ViewHolder)} <b>without</b> calling
         * {@link #dispatchAnimationStarted(ViewHolder)}.
         *
         * @param viewHolder The RecyclerViewHolder whose animation is starting.
        ...
        /**
         * Called when a new animation is started on the given RecyclerViewHolder.
         *
         * @param viewHolder The RecyclerViewHolder which started animating. Note that the RecyclerViewHolder
         ...
         * the same RecyclerViewHolder for animations or RecyclerView should create a copy of the
         ...
         *
         * @param viewHolder The RecyclerViewHolder which represents the changed item's old content.
         * @return True if RecyclerView should just rebind to the same RecyclerViewHolder or false if
         * RecyclerView should create a new RecyclerViewHolder and pass this RecyclerViewHolder to the
         ...
         * RecyclerViewHolder. This information will later be passed into <code>animate**</code> methods.
         * <p>
        ...
        public static class ItemHolderInfo {
             ...
             * the given RecyclerViewHolder. Clears all {@link #changeFlags}.
             *
             * @param holder The RecyclerViewHolder whose bounds should be copied.
            ...
            /**
             * Sets the {@link #left}, {@link #top}, {@link #right} and {@link #bottom} values from
             * the given RecyclerViewHolder and sets the {@link #changeFlags} to the given flags parameter.
             *
             * @param holder The RecyclerViewHolder whose bounds should be copied.
